...
const styles = StyleSheet.create({
  ...
  signOutButton: { height: 46, borderRadius: radii.sm, backgroundColor: '#FFE9E2', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  rowIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: '#F2F4F7', alignItems: 'center', justifyContent: 'center' },
  ...
  resetButton: { height: 52, borderRadius: radii.md, backgroundColor: '#FFE9E2', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, ...shadows.card },
